class AuthenticationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @authentication.save
        format.html { redirect_to authentications_url, notice: "An account #{@authentication.user_name}(#{@authentication.user_id}) was successfully created." }
  ...
  def update
    respond_to do |format|
      if @authentication.update(authentication_params)
        format.html { redirect_to authentications_url, notice: "Your account #{@authentication.user_name}(#{@authentication.user_id}) was successfully updated." }
  ...
  private
    ...
    def authentication_params
      params.require(:authentication).permit(:user_id, :user_name, :password, :password_confirmation)
    end
end
